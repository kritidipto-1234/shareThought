...
function alertMsg(content) {
  var time = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 2200;
  clearTimeout(timer);
...
var loginFormSelector = document.querySelector('.loginFormBtn');
var signUpFormSelector = document.querySelector('.signUpFormBtn');
var forgotPasswordFormSelector = document.querySelector('.forgotPasswordFormBtn');
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "".concat(config.URL, "/api/users/login"),
              data: {
                email: email,
                password: password
              }
          ...
          case 9:
            ...
            (0, _alert.alertMsg)(_context.t0.response.data.error.message, 3000);
...
function _signUp() {
  _signUp = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
    var name, email, description, password, passwordConfirm, result;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            description = signUpForm.querySelector('.description').value;
            password = signUpForm.querySelector('.password').value;
            passwordConfirm = signUpForm.querySelector('.passwordConfirm').value;
            _context2.next = 8;
            return (0, _axios.default)({
              method: 'POST',
              url: "".concat(config.URL, "/api/users/createUser"),
              data: {
                name: name,
                email: email,
          ...
          case 12:
            ...
            (0, _alert.alertMsg)(_context2.t0.response.data.error.message, 3000);
...
function requestPasswordChange(_x3) {
  return _requestPasswordChange.apply(this, arguments);
}

function _requestPasswordChange() {
  _requestPasswordChange = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
    var email, result;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            (0, _alert.alertMsg)('Wait a few seconds', 13000);
            _context3.next = 5;
            return (0, _axios.default)({
              method: 'POST',
              url: "".concat(config.URL, "/api/users/forgotPassword"),
              data: {
                email: email
              }
            });
          ...
          case 5:
            ...
            if (result.data.status === 'success') (0, _alert.alertMsg)('A link has been send to the entered email. Click on that to change password', 5000);
            _context3.next = 12;
            break;
          ...
          case 9:
            ...
            (0, _alert.alertMsg)(_context3.t0.response.data.error.message, 3000);
...
},{"axios":"../../node_modules/axios/index.js","./config.js":"config.js","./alert.js":"alert.js"}],"../../node_modules/jwt-decode/build/jwt-decode.esm.js":[function(require,module,exports) {
"use strict";
...
},{}],"globalPage.js":[function(require,module,exports) {
"use strict";
...
var postsContainer = document.querySelector('.allPosts');
var postBtn = document.querySelector('.postBtn');
var postContent = document.querySelector('.postContent');
var rightHeader = document.querySelector('.headerRight').querySelector('span');

function getFormattedDate(d) {
  var date = new Date(d);
  return "".concat(date.toDateString(), " at ").concat(date.getHours(), ":").concat(date.getMinutes());
}

function renderPosts(posts, container) {
  var isPostsDeletable = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  postsContainer.innerHTML = '';
  posts.forEach(function (p) {
    container.insertAdjacentHTML('afterbegin', "<div class=\"post\" data-postid=".concat(p._id, "> \n            <div class=\"postUserName\"  data-userid=").concat(p.postedBy._id, " >").concat(p.postedBy.name || 'Deleted User', "</div>\n            <div class=\"postUserDescription\">").concat(isPostsDeletable ? '<div class="deletePostBtn">DELETE</div>' : p.postedBy.description || '', "</div>\n            <div class=\"postDate\">").concat(getFormattedDate(p.createdAt), "</div>\n            <div class=\"postContent\">").concat(p.content, "</div>\n        </div>"));
  });
}

function getCookieValue(name) {
  return document.cookie.split('; ').find(function (e) {
    return e.startsWith("".concat(name, "="));
  }).split('=')[1];
}

function fetchAllPosts() {
  return _fetchAllPosts.apply(this, arguments);
}

function _fetchAllPosts() {
  _fetchAllPosts = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var result;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "".concat(config.URL, "/api/posts/getAllPosts")
            });

          case 3:
            result = _context.sent;
            if (result.data.status === 'success') renderPosts(result.data.posts, postsContainer);
            _context.next = 10;
            break;
...
function _createPost() {
  _createPost = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var content, result;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            (0, _alert.alertMsg)('Post must be within 140 characters');
          ...
          case 5:
            ...
            return (0, _axios.default)({
              ...
              url: "".concat(config.URL, "/api/posts/createPost")
            });
          ...
          case 11:
            (0, _alert.alertMsg)('Posted in global feed', 3000);
            postContent.value = '';
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            rightHeader.dataset.userid = (0, _jwtDecode.default)(getCookieValue('jwt')).id;
            rightHeader.addEventListener('click', function (e) {
              return location.replace("/account/".concat(e.target.dataset.userid));
            });
            postsContainer.addEventListener('click', function (e) {
              if (!e.target.closest('.postUserName')) return;
              location.replace("/account/".concat(e.target.dataset.userid));
            });
...
},{"axios":"../../node_modules/axios/index.js","./config.js":"config.js","./alert.js":"alert.js","jwt-decode":"../../node_modules/jwt-decode/build/jwt-decode.esm.js"}],"resetPasswordPage.js":[function(require,module,exports) {
"use strict";
...
var leftHeader = document.querySelector('.headerLeft').querySelector('span');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            passwordConfirm = resetPasswordForm.querySelector('.passwordConfirm').value;
            _context.next = 5;
            return (0, _axios.default)({
              method: 'PATCH',
          ...
          case 9:
            _context.prev = 9;
            _context.t0 = _context["catch"](0);
            (0, _alert.alertMsg)(JSON.stringify(_context.t0.response.data.error.message), 3000);
...
},{"axios":"../../node_modules/axios/index.js","./config.js":"config.js","./alert.js":"alert.js"}],"userProfilePage.js":[function(require,module,exports) {
"use strict";
...
var globalPage = _interopRequireWildcard(require("./globalPage.js"));
...
var leftHeader = document.querySelector('.headerLeft').querySelector('span');
var rightHeader = document.querySelector('.headerRight').querySelector('span');
var allPostsContainer = document.querySelector('.allPosts');
...
function renderUserInfo(user, noOfPosts) {
  userInfo.innerHTML = "\n    <div class=\"info\"><span class=\"type\">Name : </span><span class=\"infoname\">".concat(user.name, "</div></div>\n    <div class=\"info\"><span class=\"type\">Description : </span><span class=\"infodescription\">").concat(user.description || '', "</span></div>\n    <div class=\"info\"><span class=\"type\">Email : </span><span class=\"infoemail\">").concat(user.email, "</span></div>\n    <div class=\"info\"><span class=\"type\">No of Posts : </span>").concat(noOfPosts, "</div>\n    <div class=\"info\"><span class=\"type\">Joined : </span>").concat(formattedDate(user.joined), "</div>\n    ");
}
...
function _getUserInfo() {
  _getUserInfo = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var isPostsDeletable,
        id,
        result,
        _args = arguments;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            isPostsDeletable = _args.length > 0 && _args[0] !== undefined ? _args[0] : false;
            _context.prev = 1;
            id = getAccountIdFromUrl();
            _context.next = 5;
            return (0, _axios.default)({
              method: 'GET',
              url: "".concat(config.URL, "/api/users/viewAccount/").concat(id)
            });

          case 5:
            result = _context.sent;
            if (result.data.status === 'success') renderUserProfile(result.data, isPostsDeletable);
            _context.next = 12;
            break;
  ...
  _init = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            rightHeader.dataset.userid = (0, _jwtDecode.default)(globalPage.getCookieValue('jwt')).id;
            leftHeader.classList.add('pageLink');
            rightHeader.classList.add('pageLink');
            leftHeader.addEventListener('click', function () {
              return location.replace('/global');
            });
            rightHeader.addEventListener('click', function (e) {
              return location.replace("/account/".concat(e.target.dataset.userid));
            });
...
},{"jwt-decode":"../../node_modules/jwt-decode/build/jwt-decode.esm.js","./globalPage.js":"globalPage.js","axios":"../../node_modules/axios/index.js","./config.js":"config.js","./alert.js":"alert.js"}],"myAccountPage.js":[function(require,module,exports) {
"use strict";
...
var userProfilePage = _interopRequireWildcard(require("./userProfilePage.js"));
...
var closeDeleteAccountFormBtn = document.querySelector('.closeDeleteAccountForm');
var cancelDeleteAccountBtn = document.querySelector('.cancelDeleteAccount');
var confirmDeleteAccountBtn = document.querySelector('.confirmDeleteAccount');
var editAccountForm = document.querySelector('.editAccountForm');
var closeEditAccountFormBtn = document.querySelector('.closeEditAccountForm');
var cancelEditAccountBtn = document.querySelector('.cancelEditAccount');
var confirmEditAccountBtn = document.querySelector('.confirmEditAccount');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "".concat(config.URL, "/api/users/logout")
            });
...
function _deletePost() {
  _deletePost = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
    var result;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            _context2.next = 5;
            return (0, _axios.default)({
              url: "".concat(config.URL, "/api/posts/deletePost/").concat(e.target.closest('.post').dataset.postid),
              method: 'DELETE'
            });
          ...
          case 5:
            ...
            (0, _alert.alertMsg)('Post Deleted', 3000);
            _context2.next = 13;
            break;
...
function _deleteAccount() {
  _deleteAccount = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var password, result;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            password = deleteAccountForm.querySelector('.password').value;
            _context3.next = 4;
            return (0, _axios.default)({
              url: "".concat(config.URL, "/api/users/deleteAccount"),
              method: 'DELETE',
              data: {
                password: password
              }
...
function _editAccount() {
  _editAccount = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
    var data, result;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            data = {};
            ['name', 'email', 'description', 'newPassword', 'newPasswordConfirm', 'currentPassword'].forEach(function (e) {
              return data[e] = editAccountForm.querySelector(".".concat(e)).value;
            });
            _context4.next = 5;
            return (0, _axios.default)({
              url: "".concat(config.URL, "/api/users/editAccount"),
              method: 'PATCH',
              data: data
            });
          ...
          case 5:
            ...
            if (result.data.status === 'success') {
              closeEditForm();
              userProfilePage.getUserInfo(true);
              (0, _alert.alertMsg)('All edits saved', 3000);
              editAccountForm.querySelectorAll('input').forEach(function (e) {
                return e.value = '';
              });
            }
          ...
          case 9:
            ...
            (0, _alert.alertMsg)(_context4.t0.response.data.error.message, 3000);
...
function openEditForm() {
  ['name', 'email', 'description'].forEach(function (e) {
    return editAccountForm.querySelector(".".concat(e)).value = document.querySelector(".info".concat(e)).textContent;
  });
  overlay.style.display = 'block';
...
function init() {
  ...
  [overlay, closeDeleteAccountFormBtn, cancelDeleteAccountBtn].forEach(function (e) {
    return e.addEventListener('click', closeDeleteForm);
  });
  editAccountBtn.addEventListener('click', openEditForm);
  [overlay, closeEditAccountFormBtn, cancelEditAccountBtn].forEach(function (e) {
    return e.addEventListener('click', closeEditForm);
  });
  confirmEditAccountBtn.addEventListener('click', editAccount);
}

;
},{"jwt-decode":"../../node_modules/jwt-decode/build/jwt-decode.esm.js","./globalPage.js":"globalPage.js","./userProfilePage.js":"userProfilePage.js","axios":"../../node_modules/axios/index.js","./config.js":"config.js","./alert.js":"alert.js"}],"main.js":[function(require,module,exports) {
"use strict";
...
var landingPage = _interopRequireWildcard(require("./landingPage.js"));

var globalPage = _interopRequireWildcard(require("./globalPage.js"));

var resetPasswordPage = _interopRequireWildcard(require("./resetPasswordPage.js"));

var myAccountPage = _interopRequireWildcard(require("./myAccountPage.js"));
